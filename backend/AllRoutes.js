...
const {getPatients,getpatientdetails,uploadpatient,getfiles,chatbot,postprescription,getprediction,getreportsdetails,updatedoctornotes,getDates,signup} = require('./controllers/get_set')
