...
const {getPatients,getpatientdetails,uploadpatient,getfiles,chatbot,postprescription,getprediction,getreportsdetails,updatedoctornotes,getDates,login,newuser,passwordreset} = require('./controllers/get_set')
